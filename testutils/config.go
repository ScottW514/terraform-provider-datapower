...
data "datapower_api_security_oauth_" "test" {
  app_domain = "acceptance_test"
    ...
    TestBed: `
resource "datapower_api_security_oauth_" "acc_test" {
...
data "datapower_assembly_action_oauth_" "test" {
  app_domain = "acceptance_test"
    ...
    TestBed: `
resource "datapower_assembly_action_oauth_" "acc_test" {
...
data "datapower_crypto_sskey_" "test" {
  app_domain = "acceptance_test"
    ...
    TestBed: `
resource "datapower_crypto_sskey_" "acc_test" {
...
resource "datapower_mcf_xpath_" "test" {
  ...
  x_path_value = "value"
    ...
    Data: `
data "datapower_mcf_xpath_" "test" {
  app_domain = "acceptance_test"
}`,
    TestBed: `
resource "datapower_mcf_xpath_" "acc_test" {
  id = "AccTest_MCFXPath"
  app_domain = datapower_domain.acc_test.app_domain
  x_path_expression = "*"
  x_path_value = "value"
