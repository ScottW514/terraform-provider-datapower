...
page_title: "datapower_ws_gateway Data Source - terraform-provider-datapower"
subcategory: ""
description: |-
  
---

# datapower_ws_gateway (Data Source)
...
- `base_wsdl` (Attributes List) A proxy may use one or more WSDL files to define the service the proxy handles. Those WSDL files are defined on this page. (see [below for nested schema](#nestedatt--result--base_wsdl))
