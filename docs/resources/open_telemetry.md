...
page_title: "datapower_open_telemetry Resource - terraform-provider-datapower"
subcategory: ""
description: |-
  OpenTelemetry
  CLI Alias: otel
...
# datapower_open_telemetry (Resource)
...
- `exporter` (String) Exporter
  - CLI Alias: `exporter`
  - Reference to: `datapower_open_telemetry_exporter:id`
- `id` (String) Name of the object. Must be unique among object types in application domain.
- `sampler` (String) Sampler
  - CLI Alias: `sampler`
  - Reference to: `datapower_open_telemetry_sampler:id`
