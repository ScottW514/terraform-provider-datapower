...
var endPoints = map[string]testutils.ModelTestConfig{
	...
	"api_security_oauth_": testutils.APISecurityOAuthTestConfig,
	...
	"assembly_action_oauth_": testutils.AssemblyActionOAuthTestConfig,
	...
	"crypto_sskey_": testutils.CryptoSSKeyTestConfig,
	...
	"mcf_xpath_": testutils.MCFXPathTestConfig,
