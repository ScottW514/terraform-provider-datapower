...
func TestAccResourceRBMSettings(t *testing.T) {
	...
	steps = append(steps, resource.TestStep{
		...
		Check: resource.ComposeTestCheckFunc([]resource.TestCheckFunc{
			...
			resource.TestCheckResourceAttr("datapower_rbm_settings.test", "auoidc_scope", "openid"),
			resource.TestCheckResourceAttr("datapower_rbm_settings.test", "auoidc_key_fetch_interval", "30"),
			resource.TestCheckResourceAttr("datapower_rbm_settings.test", "auldap_search_for_dn", "false"),
			resource.TestCheckResourceAttr("datapower_rbm_settings.test", "auldap_prefix", "cn="),
			resource.TestCheckResourceAttr("datapower_rbm_settings.test", "au_force_dnldap_order", "false"),
			...
			resource.TestCheckResourceAttr("datapower_rbm_settings.test", "auldap_read_timeout", "60"),
			resource.TestCheckResourceAttr("datapower_rbm_settings.test", "mc_method", "local"),
			resource.TestCheckResourceAttr("datapower_rbm_settings.test", "mcldap_search_for_group", "false"),
			resource.TestCheckResourceAttr("datapower_rbm_settings.test", "mcldap_read_timeout", "60"),
			...
			resource.TestCheckResourceAttr("datapower_rbm_settings.test", "mc_force_dnldap_order", "false"),
			resource.TestCheckResourceAttr("datapower_rbm_settings.test", "password_hash_algorithm", "md5crypt"),
			resource.TestCheckResourceAttr("datapower_rbm_settings.test", "ldapssl_client_config_type", "client"),
			resource.TestCheckResourceAttr("datapower_rbm_settings.test", "mcldapssl_client_config_type", "client"),
		}...),
	})
