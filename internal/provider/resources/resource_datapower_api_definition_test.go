...
func TestAccResourceAPIDefinition(t *testing.T) {
	...
	steps = append(steps, resource.TestStep{
		...
		Check: resource.ComposeTestCheckFunc([]resource.TestCheckFunc{
			...
			resource.TestCheckResourceAttr("datapower_api_definition.test", "return_v5_responses", "false"),
			...
			resource.TestCheckResourceAttr("datapower_api_definition.test", "set_v5_request_headers", "false"),
