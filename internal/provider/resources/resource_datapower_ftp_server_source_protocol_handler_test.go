...
func TestAccResourceFTPServerSourceProtocolHandler(t *testing.T) {
	...
	steps = append(steps, resource.TestStep{
		...
		Check: resource.ComposeTestCheckFunc([]resource.TestCheckFunc{
			...
			resource.TestCheckResourceAttr("datapower_ftp_server_source_protocol_handler.test", "disable_pasvip_check", "false"),
			resource.TestCheckResourceAttr("datapower_ftp_server_source_protocol_handler.test", "disable_portip_check", "false"),
