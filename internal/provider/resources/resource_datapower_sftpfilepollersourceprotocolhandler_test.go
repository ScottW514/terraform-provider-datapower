...
func TestAccResourceSFTPFilePollerSourceProtocolHandler(t *testing.T) {
	...
	steps = append(steps, resource.TestStep{
		Config: testconfig.SFTPFilePollerSourceProtocolHandlerTestConfig.GetResourceConfig(),
		Check: resource.ComposeTestCheckFunc([]resource.TestCheckFunc{
			resource.TestCheckResourceAttr("datapower_sftpfilepollersourceprotocolhandler.test", "delay_between_polls", "60000"),
			resource.TestCheckResourceAttr("datapower_sftpfilepollersourceprotocolhandler.test", "delete_on_success", "false"),
