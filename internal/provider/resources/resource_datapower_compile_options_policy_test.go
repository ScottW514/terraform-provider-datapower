...
func TestAccResourceCompileOptionsPolicy(t *testing.T) {
	...
	steps = append(steps, resource.TestStep{
		...
		Check: resource.ComposeTestCheckFunc([]resource.TestCheckFunc{
			...
			resource.TestCheckResourceAttr("datapower_compile_options_policy.test", "wsdl_wrapped_faults", "false"),
			resource.TestCheckResourceAttr("datapower_compile_options_policy.test", "wsdl_strict_soap_version", "false"),
			resource.TestCheckResourceAttr("datapower_compile_options_policy.test", "xacml_debug", "false"),
		}...),
	})
