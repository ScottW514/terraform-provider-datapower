...
func TestAccResourceWSGateway(t *testing.T) {
	...
	steps = append(steps, resource.TestStep{
		...
		Check: resource.ComposeTestCheckFunc([]resource.TestCheckFunc{
			...
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "auto_create_sources", "false"),
			...
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "wsm_agent_monitor", "true"),
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "wsm_agent_monitor_pcm", "all-messages"),
			...
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "wsa_mode", "sync2sync"),
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "wsa_require_aaa", "true"),
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "wsa_strip", "true"),
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "wsa_default_reply_to", "http://schemas.xmlsoap.org/ws/2004/08/addressing/role/anonymous"),
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "wsa_default_fault_to", "http://schemas.xmlsoap.org/ws/2004/08/addressing/role/anonymous"),
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "wsa_force", "false"),
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "wsa_gen_style", "sync"),
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "wsahttp_async_response_code", "204"),
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "wsa_timeout", "120"),
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "wsrm_enabled", "false"),
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "wsrm_sequence_expiration", "3600"),
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "wsrm_destination_accept_create_sequence", "true"),
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "wsrm_destination_maximum_sequences", "400"),
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "wsrm_destination_in_order", "false"),
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "wsrm_destination_maximum_in_order_queue_length", "10"),
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "wsrm_destination_accept_offers", "false"),
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "wsrm_front_force", "false"),
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "wsrm_back_force", "false"),
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "wsrm_back_create_sequence", "false"),
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "wsrm_front_create_sequence", "false"),
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "wsrm_source_make_offer", "false"),
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "wsrm_uses_sequence_ssl", "false"),
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "wsrm_source_maximum_sequences", "400"),
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "wsrm_source_retransmission_interval", "10"),
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "wsrm_source_exponential_backoff", "true"),
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "wsrm_source_maximum_retransmissions", "4"),
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "wsrm_source_maximum_queue_length", "30"),
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "wsrm_source_request_ack_count", "1"),
			resource.TestCheckResourceAttr("datapower_ws_gateway.test", "wsrm_source_inactivity_close", "360"),
