...
func TestAccResourceSNMPSettings(t *testing.T) {
	...
	steps = append(steps, resource.TestStep{
		Config: testconfig.SNMPSettingsTestConfig.GetResourceConfig(),
		Check: resource.ComposeTestCheckFunc([]resource.TestCheckFunc{
			resource.TestCheckResourceAttr("datapower_snmpsettings.test", "enabled", "false"),
			resource.TestCheckResourceAttr("datapower_snmpsettings.test", "local_address", "0.0.0.0"),
			resource.TestCheckResourceAttr("datapower_snmpsettings.test", "local_port", "161"),
			...
			resource.TestCheckResourceAttr("datapower_snmpsettings.test", "status_mib_mq", "/mqStatusMIB.txt"),
			resource.TestCheckResourceAttr("datapower_snmpsettings.test", "notif_mib", "/drNotificationMIB.txt"),
			resource.TestCheckResourceAttr("datapower_snmpsettings.test", "notif_mib_mq", "/mqNotificationMIB.txt"),
		}...),
	})
