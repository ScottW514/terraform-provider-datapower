...
func (d *AssemblyActionRateLimitInfoDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "A rate limit details assembly action uses a GraphQL query to return information about rate limit, burst limit, and count limit definitions. <p>This action is not supported in IBM Cloud. Any assembly that includes it fails.</p>",
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"input": schema.StringAttribute{
							MarkdownDescription: "Specify the API context variable for the input. The input variable is a variable in the API context that contains the GraphQL query to return rate limit details. The content of the <tt>body</tt> field is the input. By default, the variable name is <tt>message</tt> .",
							Computed:            true,
						},
