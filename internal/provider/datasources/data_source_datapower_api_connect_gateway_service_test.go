...
func TestAccDataSourceAPIConnectGatewayService(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testutils.APIConnectGatewayServiceTestConfig.GetDataConfig(),
				Check: resource.ComposeTestCheckFunc([]resource.TestCheckFunc{
					resource.TestCheckResourceAttr("data.datapower_api_connect_gateway_service.test", "enabled", "false"),
					resource.TestCheckResourceAttr("data.datapower_api_connect_gateway_service.test", "local_address", "0.0.0.0"),
					resource.TestCheckResourceAttr("data.datapower_api_connect_gateway_service.test", "local_port", "3000"),
