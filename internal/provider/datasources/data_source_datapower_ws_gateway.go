				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"request_type": schema.StringAttribute{
							MarkdownDescription: "Characterizes the traffic that originates from the client. The default is SOAP.",
							Computed:            true,
						},
						"response_type": schema.StringAttribute{
							MarkdownDescription: "Characterizes the traffic that originates from the server. The default is SOAP.",
							Computed:            true,
						},
						"follow_redirects": schema.BoolAttribute{
							MarkdownDescription: "Some protocols generate redirects as part of the protocol - for example HTTP response code 302. If this property is enabled the gateway will try and transparently resolve those redirects.",
							Computed:            true,
						},
						"allow_compression": schema.BoolAttribute{
							MarkdownDescription: "Specify whether to enable or disable the GZIP compression functionality on the backside.",
							Computed:            true,
						},
						...
						"type": schema.StringAttribute{
							MarkdownDescription: "Select the mode of operation for the Web Service Proxy. The default is Static from WSDL.",
							Computed:            true,
						},
						"auto_create_source_s": schema.BoolAttribute{
							MarkdownDescription: "The front side ports that accept connections must have configured Front Side Protocol Source Handlers. If no Front Side Protocol Handler is configured and auto-create is enabled, a default Protocol Handler will be created. Currently only auto-creates HTTP sources.",
							Computed:            true,
						},
						...
						"client_principal": schema.StringAttribute{
							MarkdownDescription: "Specify the full name of the client principal when the Web Services Proxy needs to decrypt automatically encrypted requests. Use this property when the encryption uses a Kerberos session key or uses a key that was derived from the session key.",
							Computed:            true,
						},
						"server_principal": schema.StringAttribute{
							MarkdownDescription: "Specify the full name of the server principal when the Web Services Proxy needs to decrypt automatically encrypted requests. Use this property when the encryption uses a Kerberos session key or uses a key that was derived from the session key.",
							Computed:            true,
						},
						"kerberos_keytab": schema.StringAttribute{
							MarkdownDescription: "Select the Kerberos keytab file that contains the principals that the Web Services Proxy uses to decrypt automatically encrypted requests.",
							Computed:            true,
						},
						"decrypt_key": schema.StringAttribute{
							MarkdownDescription: "The ws-proxy will automatically decrypt encrypted requests. Configure the decrypt key to explicitly select the private key used in the decryption.",
							Computed:            true,
						},
						"encrypted_key_sha1_cache_life_time": schema.Int64Attribute{
							MarkdownDescription: "This is the Cache Lifetime for the decrypted generated key. Setting the value to 0 means the decrypted generated key will not be cached.",
							Computed:            true,
						},
						"preserve_key_chain": schema.BoolAttribute{
							MarkdownDescription: "Select 'on' to output the chain of elements being used by the decrypted Encrypted Data, such as xenc:EncryptedKey, wsc:DerivedKeyToken. Otherwise all the xenc:EncryptedKey elements will be removed after decryption, even some of the Encrypted Data may not be decrypted successfully.",
							Computed:            true,
						},
						"decrypt_with_key_from_ed": schema.BoolAttribute{
							MarkdownDescription: "In scenarios where the key is inside an EncryptedData element (such as 'encrypted SAML Assertion'), the decrypt action cannot locate the key to decrypt the corresponding EncryptedData elements. Select 'on', to enable decrypt action to attempt decryption with the key that is inside the EncryptedData element.",
							Computed:            true,
						},
						"soap_action_policy": schema.StringAttribute{
							MarkdownDescription: "Select how to handle the SOAPAction HTTP header.",
							Computed:            true,
						},
						...
						"w_sm_agent_monitor": schema.BoolAttribute{
							MarkdownDescription: "Control the collection of monitoring records for this service.",
							Computed:            true,
						},
