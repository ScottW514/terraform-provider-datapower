		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc([]resource.TestCheckFunc{
					resource.TestCheckResourceAttr("data.datapower_file_system_usage_monitor.test", "enabled", "true"),
					resource.TestCheckResourceAttr("data.datapower_file_system_usage_monitor.test", "polling_interval", "60"),
