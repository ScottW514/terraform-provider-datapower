...
func TestAccDataSourceXMLManager(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testutils.XMLManagerTestConfig.GetDataConfig(),
				Check: resource.ComposeTestCheckFunc([]resource.TestCheckFunc{
					...
					resource.TestCheckResourceAttr("data.datapower_xml_manager.test", "result.0.parser_limits_element_depth", "512"),
					resource.TestCheckResourceAttr("data.datapower_xml_manager.test", "result.0.parser_limits_attribute_count", "128"),
					resource.TestCheckResourceAttr("data.datapower_xml_manager.test", "result.0.parser_limits_max_node_size", "33554432"),
					resource.TestCheckResourceAttr("data.datapower_xml_manager.test", "result.0.parser_limits_external_references", "forbid"),
					resource.TestCheckResourceAttr("data.datapower_xml_manager.test", "result.0.parser_limits_max_prefixes", "1024"),
