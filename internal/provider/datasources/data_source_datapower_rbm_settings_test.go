		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc([]resource.TestCheckFunc{
					...
					resource.TestCheckResourceAttr("data.datapower_rbm_settings.test", "ldap_ssl_client_config_type", "proxy"),
					resource.TestCheckResourceAttr("data.datapower_rbm_settings.test", "mc_ldap_ssl_client_config_type", "proxy"),
				}...),
			},
		},
	})
