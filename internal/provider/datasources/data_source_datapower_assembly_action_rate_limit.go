				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"source": schema.StringAttribute{
							MarkdownDescription: "Specify the source of the limits to apply to the assembly. By default, rate limits and burst limits in the API plan are applied.",
							Computed:            true,
						},
						...
						"group_action": schema.StringAttribute{
							MarkdownDescription: "Specify the action to take for rate limits in the group. Each rate limit definition that the group references is consumed or replenished based on this setting. The default value is consume.",
							Computed:            true,
						},
