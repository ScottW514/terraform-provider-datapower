		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc([]resource.TestCheckFunc{
					...
					resource.TestCheckResourceAttr("data.datapower_api_gateway.test", "result.0.share_rate_limit_count", "yes"),
					resource.TestCheckResourceAttr("data.datapower_api_gateway.test", "result.0.front_timeout", "120"),
					resource.TestCheckResourceAttr("data.datapower_api_gateway.test", "result.0.front_persistent_timeout", "180"),
				}...),
			},
		},
	})
