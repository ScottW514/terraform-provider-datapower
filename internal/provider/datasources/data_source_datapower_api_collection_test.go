...
func TestAccDataSourceAPICollection(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testutils.APICollectionTestConfig.GetDataConfig(),
				Check: resource.ComposeTestCheckFunc([]resource.TestCheckFunc{
					resource.TestCheckResourceAttr("data.datapower_api_collection.test", "result.0.id", "AccTest_APICollection"),
					...
					resource.TestCheckResourceAttr("data.datapower_api_collection.test", "result.0.api_processing_rule", "default-api-rule"),
					resource.TestCheckResourceAttr("data.datapower_api_collection.test", "result.0.api_error_rule", "default-api-error-rule"),
				}...),
			},
		},
	})
