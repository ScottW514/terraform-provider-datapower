				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"remote_password": schema.StringAttribute{
							MarkdownDescription: "Specify the password for the account or username for non-public key authentication. Public key authentication can be configured through the default user agent.",
							Computed:            true,
						},
