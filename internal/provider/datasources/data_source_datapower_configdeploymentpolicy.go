				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"accepted_config": schema.ListAttribute{
							MarkdownDescription: "Accepted Configuration",
							ElementType:         types.StringType,
							Computed:            true,
						},
						"filtered_config": schema.ListAttribute{
							MarkdownDescription: "Filtered Configuration",
							ElementType:         types.StringType,
							Computed:            true,
						},
						"modified_config": schema.ListNestedAttribute{
							MarkdownDescription: "Modified Configuration",
							NestedObject:        models.DmConfigModifyTypeDataSourceSchema,
							Computed:            true,
						},
					},
				},
