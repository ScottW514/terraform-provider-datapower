		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc([]resource.TestCheckFunc{
					...
					resource.TestCheckResourceAttr("data.datapower_cryptokerberoskdc.test", "result.0.cache_tickets", "true"),
					resource.TestCheckResourceAttr("data.datapower_cryptokerberoskdc.test", "result.0.max_cached_tickets", "32"),
					resource.TestCheckResourceAttr("data.datapower_cryptokerberoskdc.test", "result.0.min_cached_ticket_validity", "60"),
				}...),
			},
		},
	})
