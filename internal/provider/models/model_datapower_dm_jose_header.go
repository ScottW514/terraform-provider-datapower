...
type DmJOSEHeader struct {
	HeaderName  types.String `tfsdk:"header_name"`
	HeaderValue types.String `tfsdk:"header_value"`
}

var DmJOSEHeaderObjectType = map[string]attr.Type{
	"header_name":  types.StringType,
	"header_value": types.StringType,
}
var DmJOSEHeaderObjectDefault = map[string]attr.Value{
...
func (data DmJOSEHeader) ToBody(ctx context.Context, pathRoot string) string {
	if pathRoot != "" {
		pathRoot = pathRoot + "."
	}
	body := ""
...
func (data *DmJOSEHeader) FromBody(ctx context.Context, pathRoot string, res gjson.Result) {
	if pathRoot != "" {
		pathRoot = pathRoot + "."
	}
...
func (data *DmJOSEHeader) UpdateFromBody(ctx context.Context, pathRoot string, res gjson.Result) {
	if pathRoot != "" {
		pathRoot = pathRoot + "."
	}
