...
type DmRateLimitInfo struct {
	Name   types.String `tfsdk:"name"`
	Action types.String `tfsdk:"action"`
}

var DmRateLimitInfoObjectType = map[string]attr.Type{
	"name":   types.StringType,
	"action": types.StringType,
}
var DmRateLimitInfoObjectDefault = map[string]attr.Value{
...
func (data DmRateLimitInfo) ToBody(ctx context.Context, pathRoot string) string {
	if pathRoot != "" {
		pathRoot = pathRoot + "."
	}
	body := ""
...
func (data *DmRateLimitInfo) FromBody(ctx context.Context, pathRoot string, res gjson.Result) {
	if pathRoot != "" {
		pathRoot = pathRoot + "."
	}
...
func (data *DmRateLimitInfo) UpdateFromBody(ctx context.Context, pathRoot string, res gjson.Result) {
	if pathRoot != "" {
		pathRoot = pathRoot + "."
	}
