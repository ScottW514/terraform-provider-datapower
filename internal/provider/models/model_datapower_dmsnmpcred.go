...
var DmSnmpCredDataSourceSchema = DataSourceSchema.NestedAttributeObject{
	Attributes: map[string]DataSourceSchema.Attribute{
		"engine_id": DataSourceSchema.StringAttribute{
			MarkdownDescription: tfutils.NewAttributeDescription("Engine ID", "", "").String,
			Computed:            true,
		},
		"auth_protocol": DataSourceSchema.StringAttribute{
			MarkdownDescription: tfutils.NewAttributeDescription("Authentication protocol", "", "").AddStringEnum("none", "md5", "sha").AddDefaultValue("sha").String,
			Computed:            true,
		},
		"auth_secret_type": DataSourceSchema.StringAttribute{
			MarkdownDescription: tfutils.NewAttributeDescription("Authentication value type", "", "").AddStringEnum("password", "key").AddDefaultValue("password").String,
			Computed:            true,
		},
		"auth_secret": DataSourceSchema.StringAttribute{
			MarkdownDescription: tfutils.NewAttributeDescription("Authentication value", "", "").String,
			Computed:            true,
		},
		"priv_protocol": DataSourceSchema.StringAttribute{
			MarkdownDescription: tfutils.NewAttributeDescription("Privacy protocol", "", "").AddStringEnum("none", "des", "aes").AddDefaultValue("des").String,
			Computed:            true,
		},
		"priv_secret_type": DataSourceSchema.StringAttribute{
			MarkdownDescription: tfutils.NewAttributeDescription("Privacy value type", "", "").AddStringEnum("password", "key").AddDefaultValue("password").String,
			Computed:            true,
		},
		"priv_secret": DataSourceSchema.StringAttribute{
			MarkdownDescription: tfutils.NewAttributeDescription("Privacy value", "", "").String,
			Computed:            true,
		},
	},
}
