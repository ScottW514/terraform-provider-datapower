	...
	var DmAssemblyActionSetVarDataSourceSchema = DataSourceSchema.NestedAttributeObject{
		Attributes: map[string]DataSourceSchema.Attribute{
			"action": DataSourceSchema.StringAttribute{
				MarkdownDescription: "Specify the action to manage the variable.",
				Computed:            true,
			},
			...
			"type": DataSourceSchema.StringAttribute{
				MarkdownDescription: "Specify the data type of the variable. You must define this property to set or add a variable.",
				Computed:            true,
			},
