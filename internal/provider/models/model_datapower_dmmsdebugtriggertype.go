...
var DmMSDebugTriggerTypeDataSourceSchema = DataSourceSchema.NestedAttributeObject{
	Attributes: map[string]DataSourceSchema.Attribute{
		"client_ip": DataSourceSchema.StringAttribute{
			MarkdownDescription: tfutils.NewAttributeDescription("Client-IP Match", "", "").String,
			Computed:            true,
		},
		"in_url_match": DataSourceSchema.StringAttribute{
			MarkdownDescription: tfutils.NewAttributeDescription("Inbound URL Match", "", "").String,
			Computed:            true,
		},
		"out_url_match": DataSourceSchema.StringAttribute{
			MarkdownDescription: tfutils.NewAttributeDescription("Outbound URL Match", "", "").String,
			Computed:            true,
		},
		"rule_type": DataSourceSchema.StringAttribute{
			MarkdownDescription: tfutils.NewAttributeDescription("Processing Type", "", "").AddStringEnum("all", "response", "request", "call", "error", "scheduled", "lbhealth").String,
			Computed:            true,
		},
		"rule_match": DataSourceSchema.StringAttribute{
			MarkdownDescription: tfutils.NewAttributeDescription("Processing Rule Match", "", "").String,
			Computed:            true,
		},
		"x_path": DataSourceSchema.StringAttribute{
			MarkdownDescription: tfutils.NewAttributeDescription("XPath Expression Match", "", "").String,
			Computed:            true,
		},
	},
}
