		...
		Attributes: map[string]ResourceSchema.Attribute{
			...
			"auth_secret_type": ResourceSchema.StringAttribute{
				...
				Validators: []validator.String{
					...
					validators.ConditionalRequiredString(DmSnmpCredAuthSecretTypeCondVal, validators.Evaluation{}, true),
				},
			...
			"auth_secret_wo": ResourceSchema.StringAttribute{
				...
				Optional:            true,
				Validators: []validator.String{
					validators.ConditionalRequiredString(DmSnmpCredAuthSecretCondVal, validators.Evaluation{}, false),
				},
			},
			...
			"priv_secret_type": ResourceSchema.StringAttribute{
				...
				Validators: []validator.String{
					stringvalidator.OneOf("password", "key"),
					validators.ConditionalRequiredString(DmSnmpCredPrivSecretTypeCondVal, validators.Evaluation{}, true),
				},
				Default: stringdefault.StaticString("password"),
			},
			"priv_secret_wo": ResourceSchema.StringAttribute{
				...
				Optional:            true,
				Validators: []validator.String{
					validators.ConditionalRequiredString(DmSnmpCredPrivSecretCondVal, validators.Evaluation{}, false),
				},
			},
