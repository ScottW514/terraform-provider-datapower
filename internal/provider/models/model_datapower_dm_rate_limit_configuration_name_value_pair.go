...
type DmRateLimitConfigurationNameValuePair struct {
	Name  types.String `tfsdk:"name"`
	Value types.String `tfsdk:"value"`
}

var DmRateLimitConfigurationNameValuePairObjectType = map[string]attr.Type{
	"name":  types.StringType,
	"value": types.StringType,
}
var DmRateLimitConfigurationNameValuePairObjectDefault = map[string]attr.Value{
...
func (data DmRateLimitConfigurationNameValuePair) ToBody(ctx context.Context, pathRoot string) string {
	if pathRoot != "" {
		pathRoot = pathRoot + "."
	}
	body := ""
...
func (data *DmRateLimitConfigurationNameValuePair) FromBody(ctx context.Context, pathRoot string, res gjson.Result) {
	if pathRoot != "" {
		pathRoot = pathRoot + "."
	}
...
func (data *DmRateLimitConfigurationNameValuePair) UpdateFromBody(ctx context.Context, pathRoot string, res gjson.Result) {
	if pathRoot != "" {
		pathRoot = pathRoot + "."
	}
