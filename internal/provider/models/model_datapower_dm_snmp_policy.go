...
var DmSnmpPolicyObjectType = map[string]attr.Type{
	"community": types.StringType,
	"domain":    types.StringType,
	"mode":      types.StringType,
	"host":      types.StringType,
}
var DmSnmpPolicyObjectDefault = map[string]attr.Value{
...
func GetDmSnmpPolicyDataSourceSchema() DataSourceSchema.NestedAttributeObject {
	...
	return DmSnmpPolicyDataSourceSchema
}
func GetDmSnmpPolicyResourceSchema() ResourceSchema.NestedAttributeObject {
	var DmSnmpPolicyResourceSchema = ResourceSchema.NestedAttributeObject{
	...
	return DmSnmpPolicyResourceSchema
}

func (data DmSnmpPolicy) IsNull() bool {
...
func (data DmSnmpPolicy) ToBody(ctx context.Context, pathRoot string) string {
	if pathRoot != "" {
		pathRoot = pathRoot + "."
	}
	body := ""
...
func (data *DmSnmpPolicy) FromBody(ctx context.Context, pathRoot string, res gjson.Result) {
	if pathRoot != "" {
		pathRoot = pathRoot + "."
	}
...
func (data *DmSnmpPolicy) UpdateFromBody(ctx context.Context, pathRoot string, res gjson.Result) {
	if pathRoot != "" {
		pathRoot = pathRoot + "."
	}
